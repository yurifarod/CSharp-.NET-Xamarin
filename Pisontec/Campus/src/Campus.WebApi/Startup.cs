...
using System.IO;
using Campus.WebApi.Configurations;
using MediatR;
using Microsoft.AspNetCore.Mvc;
using Swashbuckle.AspNetCore.Swagger;
using Microsoft.AspNetCore.Identity;

namespace Campus.WebApi
{
  public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(s =>
            {
                s.SwaggerDoc("v1", new Info
                {
                    ...
                    Description = "Campus API Swagger surface",
                    Contact = new Contact { Name = "Rui Flexa", Email = "rui@campussolucoes.com", Url = "http://campussolucoes.com" },
                    License = new License { Name = "Baseado em Projeto Clean Architecture do Edu Pires(MVP)", Url = "#" }
                });
            });
                              ...
                              IHttpContextAccessor accessor)
        {
            ...
            app.UseSwaggerUI(s =>
            {
                s.SwaggerEndpoint("/swagger/v1/swagger.json", "Campus Project API v1.1");
            });
        }
